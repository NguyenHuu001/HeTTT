                    ...
                    <div>
                        <div className="col-md-4">
                            ...
                            <div className="d-flex flex-column align-items-center">
                                <span className="item">340.000đ</span>
                                <span className="mt-3">Pizza nhân bò phô mai</span>
                            </div>
                            <div className="btn_buy justify-content-center">
                                <button className="d-flex">Thêm</button>
                            </div>
                        </div>
                    </div>
                </div>
